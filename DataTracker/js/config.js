...
var serviceUrl = '//cdms.ctuir.org/services'; //location of cdms-services deployment (REST Services)
var serverUrl = '//cdms.ctuir.org/cdms';       //location of cdms-dev files (Javascript+HTML application)
